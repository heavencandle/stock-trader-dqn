...
class OpenApi(QAxWidget):
    ...
    # 키움증권의 OpenApi+ 사용하기 위해 COM Object 생성
    ...
    def _set_signal_slots(self):
        try:
            ...
            self.OnReceiveChejanData.connect(self._receive_chejan_data) # 주문체결 시점에서 키움증권 서버가 발생시키는 OnReceiveChejanData 이벤트를 처리하는 메서드
